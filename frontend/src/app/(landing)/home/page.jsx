...
import DonationCard from "@/components/card/CampaignCard";
      ...
      >
        ...
        >
          ...
          <motion.div variants={zoomIn} transition={{ delay: 0.4 }}>
            <PrimaryButton className="mt-2 w-[120px]" nextRoute="/campaigns">
              Donasi
            </PrimaryButton>
          </motion.div>
        </motion.div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <motion.div variants={fadeIn} custom={0.8}>
              <PrimaryButton className="mt-4" nextRoute="/campaigns">
                Gerak Donasi
              </PrimaryButton>
            </motion.div>
          </motion.div>
