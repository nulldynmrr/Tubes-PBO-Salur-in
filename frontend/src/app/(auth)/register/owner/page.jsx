...
import { validateForm as runFormValidation } from "@/lib/utils/form-validator";
...
const RegisterOwner = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg =
        error.response?.data || "Registrasi gagal. Silakan coba lagi.";
      toast.error(msg);
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <>
      <Head>
        <title>Daftar Campaign Owner - Salurin</title>
        <meta
          name="description"
          content="Daftarkan diri Anda sebagai campaign owner di Salurin."
        />
      </Head>
